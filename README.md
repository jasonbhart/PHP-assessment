...
6. Modify code to meet PSR-1 and PSR-2 code style guidelines. Do NOT incorporate PSR-0 or PSR-4, as required by PSR-1. Make use of self-documenting code principles.
...
12. Push ALL changes back to your forked repository, including your new database (in .sql export format)
